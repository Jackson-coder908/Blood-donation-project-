...
// Put this at the very top of admin.js or dashboard scripts
if (localStorage.getItem('role') !== 'recipient') {
    alert('Access Denied: High-tier permissions required.');
    window.location.href = 'login-recipient.html';
}
